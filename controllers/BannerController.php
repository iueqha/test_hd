<?php
class BannerController extends Cola_Controller
{
    //添加
    public function addAction()
    {
        ...
        $bannerClass = new BannerModel();
        $ret = $bannerClass->create($title,$pic,$place);
        var_dump($ret);
    }
    ...
    public function viewAction()
    {
        ...
        $id = $this->get('id');
        $this->view->id = $id;
        $this->view->msg = '伟大领袖毛主席无限正确!';
        $this->response->charset();
        $this->display('views/index.php');
    }
